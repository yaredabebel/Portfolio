  ...
  return (
    <section className="w-full relative select-none" ref={targetSection}>
      ...
      >
        ...
        <h3
          ref={quoteRef}
          className="font-medium text-[1.70rem] md:text-6xl lg:text-[2.5rem] text-center"
        >
          <span className="about-3 font-bold"> Fun fact about me, </span> I like
          playing instruments and making
          <span className="about-3 font-bold"> MUSIC.</span>
        </h3>
      </div>
      <style jsx global>{`
        .about-3 {
